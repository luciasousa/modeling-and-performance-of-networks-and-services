...
while TRANSMITTEDPACKETS<P               % Stopping criterium
    ...
    switch Event
        ...
        case DEPARTURE  % If first event is a DEPARTURE
            % probabilidade de chegar sem erros
            p_0erros = (1-b)^(PacketSize*8);
            if rand() <= p_0erros % pacote chegou sem erros, atualiza bytes transmitidos
            ...
            else % pacote chegou com erros, é descartado
                LOSTPACKETS = LOSTPACKETS + 1;
            end
